...
| Field | Value |
|---|---|
| Repository | `python_example_file_handling` |
...
File reading and writemg routines with path validation. This document describes requirements, architecture, and acceptance criteria.
